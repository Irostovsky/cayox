...
begin
  ...
  Merb::Authentication.user_class.class_eval do
    ...
    # remove merb-auth password validators because we supply our own with translated error messages
    validators.context(:default).reject! { |v| v.field_name == :password && v.instance_variable_get(:@options)[:message].nil? }
  end
