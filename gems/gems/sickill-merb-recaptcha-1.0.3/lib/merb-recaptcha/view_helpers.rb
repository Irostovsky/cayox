...
module Merb # :nodoc:
  module Helpers # :nodoc:
    module Recaptcha
      ...
      #     ....
      #     </script>
      #   If you want recaptcha to be inserted into DOM right now 
      #   (without waiting for onload event, usefull for embeding recaptcha in ajax modal windows) use :instant as ajax value:
      #     <%= recaptcha_tags :ajax => :instant %>
      #     <div id="recaptcha"></div>
      #   This code generates following:
      #     <script type="text/javascript">
      #     ....
      ...
      def recaptcha_tags(options = {})
        ...
        if ajax
          ...
          xhtml.script(:type => "text/javascript") do |js|
            ...
            if ajax == :instant
              js << "Recaptcha.create('#{public_key}', document.getElementById('#{element_id}'), options);\n"
            elsif ajax == :jquery
